...
\begin{frame}
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[xshift=2cm,xscale=-1] at (2+\insertoverlaynumber*8/350,1) {\includegraphics[width=2.5cm]{Hang_gliding_leonardo}};
    ...
    \node at (9,-1) {\includegraphics[width=5cm]{dante_duck}};
