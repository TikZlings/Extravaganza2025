...
# convert to images
pdftoppm -png -r 48 -progress -singlefile -f 49 flower-field.pdf flower-field
pdftoppm -r 240 -progress flower-field.pdf flower-field

# convert to video
ffmpeg \
  -ss 00:00:00 -i flower-field-%03d.ppm \
