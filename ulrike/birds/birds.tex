...
\ifnum \birdscene=2 
\path (-2,3)--(3,2)node[pos=\fpeval{\the\value{page}/240}]{\includegraphics[width=1.55cm]{hummingbird}};
\fi
...
\inscene{}{\path (4.5,1)node{\includegraphics[width=1.5cm]{ceredaduck}};}{}

\inscene{}{\path (0,0.4)node{\includegraphics[width=1.5cm]{davidduck}};}{} 

\inscene{}{}{\path%[thick,red,->] 
(-2,15)--(2,8)node[pos=\fpeval{\the\value{page}/336}]{\includegraphics[width=1.5cm]{davidbird}};} 
\end{tikzpicture}
\end{frame}}
