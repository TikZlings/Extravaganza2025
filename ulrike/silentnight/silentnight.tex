...
\setbeamertemplate{background canvas}{\includegraphics[width=\paperwidth]{tropical-beach}}
...
\begin{frame}
  \begin{tikzpicture}[remember picture, overlay]
   ...
   \path
    ...
    \node[black,text width=\paperwidth,font=\tiny,align=center] at ([yshift=0.35cm]current page.south) {Image source: \url{https://www.freepik.com/free-photo/tropical-beach_1035215.htm}};
  \end{tikzpicture}%
  \pause[540]
\end{frame}
