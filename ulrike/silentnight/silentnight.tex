...
\newcommand\drumstickrotate{%
 \int_compare:nNnTF{\int_mod:nn{\value{page}}{10}}<{5}
  {\def\myrotate{-80}}
  {\def\myrotate{-100}}}
\ExplSyntaxOff
...
\begin{frame}
  \begin{tikzpicture}[remember picture, overlay]
   ...
   \path
    ...
    \node[white,text width=.7\paperwidth,font=\tiny,align=center] at ([yshift=0.35cm]current page.south) {Image source: \url{www.freepik.com}};           
  \end{tikzpicture}%
  \pause[120]
\end{frame}	
