...
\shade[inner color=gray!40!white, outer color=gray] (0,0) circle (\Radius);
\begin{scope}[transform shape nonlinear=true]
\pgftransformnonlinear{\spheretransformation}
\duck[scale=2.5,xshift=\X*1cm,yshift=-1.2cm];
\end{scope}
\shade[ball color=gray!70!white,opacity=0.3] (0,0) circle (\Radius);
